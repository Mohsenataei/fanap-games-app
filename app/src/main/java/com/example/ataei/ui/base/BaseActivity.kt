 ...
 * @param V A ViewModel class that inherited from [com.example.ataei.ui.base.BaseViewModel], will be used as default ViewModel of activity
 * @param B A Binding class that inherited from [androidx.databinding.ViewDataBinding], will be used for creating View of this activity
 */
